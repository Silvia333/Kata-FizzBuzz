...
describe('comprobar kata padding', function() {
    function espaciarCadena (cadena, ancho, caracter){
        if( ancho > cadena.length){
            var caracter = caracter || ' ';
            var array = cadena.split('');
            var espacios = (ancho - array.length);
   ...
   console.log(espaciarCadena('Pepe', 20, ':)'));
   
  it('comprobar si cadena es string', function(){
    expect(espaciarCadena('Pepe')).toBe('string');
  }); 
});
